...
const COPY = {
  ...
  singular: "this advisory member",
  loadError: "Advisory board could not be loaded",
  saveError: "Failed to save advisory member",
  deleteConfirm: "Remove this advisory member? Their account and public profile will be deleted. This cannot be undone.",
